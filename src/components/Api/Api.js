...
const Api = (props) => {
    ...
    useLayoutEffect(() => {
        [...document.getElementsByClassName("titles")].forEach(
            (element, index) => {
                element.addEventListener("click", () => {
                    const self =
                        document.getElementsByClassName("itemWrap")[index];
            ...
            (element, index) => {
                [...element.children].forEach((childElement, childIndex) => {
                    ...
                    childElement.addEventListener("click", () => {
                        [...document.getElementsByClassName("no")].forEach(
                            (delement) => {
        ...
        document.getElementsByClassName("itemWrap")[props.number].style.height =
            document.getElementsByClassName("itemWrap")[props.number]
                .scrollHeight + "px";
        document.getElementById(
            `item${props.number + 1}Fill`
        ).style.opacity = 1;
        document
            ...
            window.addEventListener("scroll", () => {
                ...
                [
                    ...
                    if (Math.floor(elementOffset) <= 0) {
                        if (
                            hun + index * 47 >=
                            (document.getElementsByClassName("docsWrap")[0]
                                .children.length -
                                1) *
                                47
                        ) {
    ...
    useLayoutEffect(() => {
        ...
        [
            ...document.getElementsByClassName("itemWrap")[Number(page) - 1]
                .children,
        ].forEach((element) => {
            if (element.classList.contains("no")) return;
            [
                ...document.getElementsByClassName("docsWrap")[0].children,
            ].forEach((docsElement, index) => {
                    ...
                    <Route path="/docs/1">
                        <S.DocsWrapper className="docsWrap">
                            <S.DocsSection>
                                ...
                                <S.DocsDes>
                                    우리 DSM Auth는 동아리별 여러 프로젝트에서
                                    편하게 로그인을 구현할 수 있고, <br />
                                    사용자들이 새로 계정을 만들 필요가 없어
                                    접근성을 더욱 쉽게 만들어줄 수 있는 서비스
                                    입니다. <br />
                                    <br />
                                    <S.DocsSubTitle>
                                        Made By Semicolon
                            ...
                            <S.DocsSection>
                                ...
                                <S.DocsImg src={des2} />
                                <S.DocsDes>
                                    내 어플리케이션 옆 + 버튼을 클릭해줍니다.
                                </S.DocsDes>
                                <S.DocsImg src={des3} />
                                <S.DocsDes>
                                    제시된 칸을 모두 채운 후 등록 버튼을
                                    클릭합니다.
                                </S.DocsDes>
                                <S.DocsImg src={des4} />
                                <S.DocsDes>
                    ...
                    <Route path="/docs/2">
                        <S.DocsWrapper className="docsWrap">
                            <S.DocsSection>
                                ...
                                <S.DocsSubTitle>주의사항</S.DocsSubTitle>
                                <S.DocsDes>
                                    이 문서는 안드로이드에서 DSM_Auth를 사용하는
                                    방법을 안내합니다.
                                </S.DocsDes>
                                <S.DocsSubTitle>요구사항</S.DocsSubTitle>
                                <S.DocsDes>
                                    DSMSDK를 사용하기 위한 최소 요구사양은
                                    아래와 같습니다.
                                    <br /> - Android api level 23(Android
                                    6.0)이상
                                </S.DocsDes>
                            </S.DocsSection>
                            <S.DocsSection>
                                ...
                                <S.DocsDes>
                                    1. Module 수준의 build.gradle에 다음
                                    dependencies 를 추가해줍니다.
                                </S.DocsDes>
                                <SyntaxHighlighter
                                    language="kotlin"
                                    style={atomDark}
                                >
                                    implementation
                                    'com.semicolon.dsm_sdk_v1:dsmauth:1.2.8'
                                </SyntaxHighlighter>
                                <S.DocsDes>
                                    2. <b>sync now</b> 를 클릭합니다.
                                    <br />
                                    <br />
                                    3. sdk를 사용할때 원할한 인터넷통신을 위해서
                                    다음코드를 <b>AndroidManifest.xml</b> 에
                                    추가해줍니다.
                                </S.DocsDes>
                                <SyntaxHighlighter
                                    language="kotlin"
                                ...
                                <S.DocsDes>
                                    2. 발급받은 client id,client secret, 그리고
                                    프로젝트의 redirectURL(없을경우 발급받은
                                    default redirectURL)을 통해서 DsmSdk를
                                    초기화 해야합니다.
                                    <br />
                                    <br /> - DsmSdk.instance.initSDK()메서드를
                                    사용합니다.
                                    <br /> - 예제의 홀화살괄호`〈 〉`로 감싸져
                                    있는 부분은 사용자가 정의해주셔야합니다.
                                </S.DocsDes>
                                <SyntaxHighlighter
                                    language="kotlin"
                                    style={atomDark}
                            ...
                            <S.DocsSection>
                                ...
                                <S.DocsDes>
                                    - DSM_Auth계정으로 로그인 하려면
                                    instance내부에 있는 loginWithAuth()메서드를
                                    사용해야합니다.
                                    <br /> - loginWithAuth()메서드를 사용하는
                                    방법은 다음과 같습니다.
                                    <br />
                                    <br /> 1. 첫번째 매개변수로 context를
                                    줍니다.
                                    <br /> 2. 두번째 매개변수로 토큰을 받았을때
                                    실행할 콜백함수를 줍니다.
                                    <br /> 3. 세번째 사용자 정보를 받았을때
                                    실행할 콜백함수를 줍니다.
                                    <br /> 4. 메서드를 실행합니다. <br />-
                                    name은 이름, email은 이메일,gcn은
                                    학번(4자리)를 반환합니다
                                    <br />
                                    <br /> - 예시코드
                                </S.DocsDes>
                            ...
                            <S.DocsSection>
                                ...
                                <S.DocsDes>
                                    - DsmSdk는 access token을 재발급 받을수있는
                                    **refreshToken()** 메서드를 지원합니다.
                                    <br /> - 파라미터로 로그인할때 받아온
                                    refresh토큰과 access token을 재발급 받았을때
                                    실행할 콜백 메서드를 넣어줍니다.
                                    <br />
                                    <br /> - 예시코드
                                </S.DocsDes>
                            ...
                            <S.DocsSection>
                                ...
                                <S.DocsDes>
                                    - DsmSdk는 accessToken으로 사용자의 정보를
                                    받아오는 **getUserInformation()** 메서드를
                                    지원합니다.
                                    <br />
                                    - 파라미터로 access token과 정보를
                                    받아왔을때 실행할 콜백메서드를 넣어줍니다.
                                    <br />
                                    <br />- 예시코드
                                </S.DocsDes>
                                <SyntaxHighlighter
                    ...
                    <Route path="/docs/3">
                        <S.DocsWrapper className="docsWrap">
                            <S.DocsSection>
                                ...
                                <S.DocsSubTitle>주의사항</S.DocsSubTitle>
                                <S.DocsDes>
                                    이 문서는 DSM_Auth를 위한 iOS DSMSDK사용법을
                                    안내합니다.
                                    <br /> 모든 예제의 홀화살괄호`〈 〉`로
                                    감싸져 있는 부분은 사용자가
                                    정의해주셔야합니다.
                            ...
                            <S.DocsSection>
                                ...
                                <S.DocsDes>
                                    ...
                                    를 이용하여 간단하게 SDK를 설치 할 수
                                    있습니다. Podfile에 DSMSDK를 추가합니다.
                                </S.DocsDes>
                                <SyntaxHighlighter
                                    language="swift"
                                    style={atomDark}
                                ...
                                <S.DocsSubTitle>
                                    외부 라이브러리 디펜던시(External library
                                    dependency)
                                </S.DocsSubTitle>
                                <S.DocsDes>
                                    DSMSDK를 설치하면 SDK에 필요한 라이브러리가
                                    자동으로 설치됩니다.
                                </S.DocsDes>
                                ...
                                <S.DocsSubTitle>초기화</S.DocsSubTitle>
                                <S.DocsDes>
                                    iOS 앱에서 DSMSDK를 사용하려면 DSMSDK 파일을
                                    아래와 같이 임포트(import)해야 합니다. 또한
                                    발급받은 클라이언트 아이디(client_id)와
                                    클라이언트 시크릿(client_secret), 입력한
                                    redirectURL을 사용해 DSMSDK를 초기화 하는
                                    과정이 필요합니다. 다음 예제를 참고하여
                                    AppDelegate.swift에 DSMSDK를 초기화하는
                                    코드를 추가합니다.
                                    <br />
                                    <br />
                                    <SyntaxHighlighter
                            ...
                            <S.DocsSection>
                                <S.DocsTitle>로그인</S.DocsTitle>
                                <S.DocsDes>
                                    DSM_Auth계정 정보를 입력하여 로그인합니다.
                                    DSM_Auth계정으로 로그인 하려면
                                    `loginWithDSMAuth()` API로 요청합니다.
                                    <br />
                                    파라미터로는 요청한 ViewController를
                                    넣습니다. `self` 키워드로 대체할 수
                                    있습니다. 이 API를 호출하면 DSMSDK가
                                    웹뷰(WKWebView)를 실행하고 DSM_Auth 로그인
                                    화면을 띄웁니다.
                                    <br />
                                    API 호출 시 결과 처리를 클로저(Closure)
                                    객체로 정의하여 전달해야 합니다. token
                                    구조체에는 엑세스 토큰(Access_Token)과
                                    리프레쉬 토큰(Refresh_Token) 정보가
                                    있습니다.
                                </S.DocsDes>
                                <SyntaxHighlighter
                                    language="swift"
                            ...
                            <S.DocsSection>
                                <S.DocsTitle>토큰 재발급</S.DocsTitle>
                                <S.DocsDes>
                                    `tokenRefresh()` API로 access token을 재발급
                                    받을 수 있습니다. 파라미터로 로그인할 때
                                    받아온 리프레쉬 토큰을 넣습니다.
                            ...
                            <S.DocsSection>
                                <S.DocsTitle>사용자 정보 받아오기</S.DocsTitle>
                                <S.DocsDes>
                                    사용자의 정보를 불러옵니다. `me()` API를
                                    호출하여 불러올 수 있습니다. 파라미터로는
                                    엑세스 토큰을 넣습니다.
                                    <br /> 다음은 사용자 정보 요청 예제입니다.
                                    user 구조체에는 이름(name), 학번(StudentID),
                                    이메일(email) 정보가 있습니다.
                                </S.DocsDes>
                                <SyntaxHighlighter
                                    language="swift"
                    ...
                    <Route path="/docs/4">
                        <S.DocsWrapper className="docsWrap">
                            <S.DocsSection>
                                <S.DocsTitle>소개</S.DocsTitle>
                                <S.DocsDes>
                                    이 문서는 DSM Auth Open API에 관한
                                    문서입니다.
                                    <br />
                                    <br />
                                    Base URL: https://developer-api.dsmkr.com
                                </S.DocsDes>
                            </S.DocsSection>
                            <S.DocsSection>
